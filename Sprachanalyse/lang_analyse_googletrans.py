...
def main(metapath):
    ...
    with open(mp) as file:
        for i in file:
            ...
            if i.split(";")[-2] == "False":
                ...
                pathList.append("/".join(
                    ["/home/mherbert/Desktop/litblogs/Kursmaterial/extraction5/2695", i.split(";")[0],
                     "extracted.txt"]))
    # print(pathList)
    resultList = []
    for path in pathList:
        ...
        #print(t_content)
        #etwas einbauen, da sonst nach dem Schema <googletrans.models.Detected object at 0x7f1d17f41668> ausgegben wird
            lang = trans.detect(t_content).lang
            lang_2 = (path, lang)
