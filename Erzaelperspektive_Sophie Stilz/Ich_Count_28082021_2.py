...
for i, csv_path in enumerate(paths):
    ...
    with open(csv_path, newline="") as csvfile:
        ...
        resultList = []
        search_list = ["ich", "meins", "mir", "meiner", "mich", "unser", "uns", "wir", "Ich", "ICH", "Meins", "MEINS", "Mir", "MIR", "Meiner", "MEINER", "Mich", "MICH", "Unser", "UNSER", "Uns", "UNS", "Wir", "WIR"]
    ...
    with open(site_name + "_ich-count" + ".pkl", "wb") as outfile:
